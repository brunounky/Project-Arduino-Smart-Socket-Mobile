...
public class ReceiverClass5 extends BroadcastReceiver {
    ...
    public void Ligar(){
        ...
        String statusTomada2 = "on";
        FirebaseDatabase.getInstance().getReference(id).child("statusTomada2")
        ...
        Log.d("ALARME", "LIGOOOOOOOU 3 " + url);
    }
    ...
    public void createNotification(String aMessage, Context context) {
        ...
        String id = "n5"; // default_channel_id
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            builder.setContentTitle(aMessage)                            // required
                    ...
                    .setContentText("Hey! A tomada 2 ligou!") // required
