...
public class ReceiverClass6 extends BroadcastReceiver {
    ...
    public void Ligar(){
        ...
        Log.d("ALARME", "DESLIGOOOOOOOU 3 " +url);
    }
    ...
    public void createNotification(String aMessage, Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            builder.setContentTitle(aMessage)                            // required
                    ...
                    .setContentText("Hey! A tomada 2 desligou!") // required
