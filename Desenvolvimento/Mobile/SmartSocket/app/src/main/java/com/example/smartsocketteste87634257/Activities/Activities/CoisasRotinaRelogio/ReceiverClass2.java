...
public class ReceiverClass2 extends BroadcastReceiver {
    ...
    public void Ligar(){
        ...
        String statusTomada1 = "off";
        FirebaseDatabase.getInstance().getReference(id).child("statusTomada1")
                .setValue(statusTomada1);


        OkHttpClient client = new OkHttpClient();

        String url = "http://"+ip+"/BF";
        ...
        Log.d("ALARME", "DESLIGOOOOOOOU 1 " + url);
    }
    ...
    public void createNotification(String aMessage, Context context) {
        ...
        String id = "n2"; // default_channel_id
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            builder.setContentTitle(aMessage)                            // required
                    ...
                    .setContentText("Hey! A tomada 1 desligou!") // required
