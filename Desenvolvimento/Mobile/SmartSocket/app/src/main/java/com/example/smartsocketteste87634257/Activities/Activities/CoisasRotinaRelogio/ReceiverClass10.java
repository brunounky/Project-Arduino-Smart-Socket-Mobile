...
public class ReceiverClass10 extends BroadcastReceiver {
    ...
    public void Ligar(){
        ...
        String statusTomada3 = "off";
        FirebaseDatabase.getInstance().getReference(id).child("statusTomada3")
        ...
        Log.d("ALARME", "DESLIGOOOOOOOU 5 " + url);
    }
    ...
    public void createNotification(String aMessage, Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            builder.setContentTitle(aMessage)                            // required
                    ...
                    .setContentText("Hey! A tomada 3 desligou!") // required
